    ...
    <div class="page-wrapper ice-theme toggled">
        ...
        <nav id="sidebar" class="sidebar-wrapper">
            ...
            <div class="sidebar-footer">
                <div>
                    <a href="<?php echo base_url(). 'dataabsenkelompok/logout'; ?>">
                          ...
                          <tbody>
                            ...
                            ?>
                                <tr>
                                  ...
                                  <td scope="row"><?php echo $setketua[$i]?></td>
                                  <td scope="row"><?php echo $setanggota1[$i]?></td>
                                  <td scope="row"><?php echo $setanggota2[$i]?></td>
                                  <td scope="row"><?php echo $jam[$i]?></td>
                                </tr>
                            <?php 
                            }?>
                          </tbody>
