    ...
    <div class="page-wrapper ice-theme toggled">
        ...
        <nav id="sidebar" class="sidebar-wrapper">
            ...
            <div class="sidebar-footer">
                <div>
                    <a href="<?php echo base_url(). 'tinjauabsen/logout'; ?>">
                          ...
                          <tbody>
                            ...
                            ?>
                                <tr>
                                  ...
                                  <td>
                                    <span><a href="<?php echo base_url(). 'tinjauabsen/terima/'.$nim."/".$jammasuk."/".$jamkeluar."/".$tanggal; ?>">Terima</a> / <a href="<?php echo base_url(). 'tinjauabsen/tolak/'.$nim."/".$jammasuk."/".$jamkeluar."/".$tanggal; ?>">Tolak</a></span>
                                  </td>
                                </tr>
                            <?php $n++;
                                }
