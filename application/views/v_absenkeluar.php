...
<html lang="en">
<head>
	<title>Absen Keluar - Magang SEA</title>
	<meta charset="UTF-8">
		...
		<div class="container-login100">
			<div class="wrap-login100">
				...
				<ul style="margin-bottom: 50px;" class="nav nav-tabs nav-justified login100-form" id="myTab" role="tablist">
	                <li class="nav-item">
	                    <a class="nav-link" id="masuk-tab" href="<?php echo site_url('')?>">Absen Masuk</a>
	                </li>
	                <li class="nav-item">
	                    <a class="nav-link active" id="keluar-tab" href="<?php echo site_url('absen_keluar')?>">Absen Keluar</a>
	                </li>
	            </ul>
				...
				<div class="col-sm" style="margin-top: -50px;">
					...
					<ul class="nav nav-tabs nav-justified login100-form" id="myTab" role="tablist">
		                ...
		                <li class="nav-item">
                            ...
                            <form class="login100-form validate-form" action="<?php echo base_url(). 'absen_keluar/insert'; ?>" method="post">
                            ...
                            <div class="tab-pane fade show" id="kelompok" role="tabpanel" aria-labelledby="kelompok-tab">
								...
								<div class="wrap-input100">
								<input class="input100" type="text" name="keterangan2" placeholder="Keterangan">
								<span class="focus-input100"></span>
								<span class="symbol-input100">
									<i class="fa fa-envelope" aria-hidden="true"></i>
								</span>
